...
template <typename B>
static BinomialNode<B>* BinomialHeap<B>::unionHeap(BinomialNode<B>* heapA, BinomialNode<B>* heapB) {
 ...
 */
template <typename B>
static BinomialNode<B>* BinomialHeap<B>::mergeHeap(BinomialNode<B>* heapA, BinomialNode<B>* heapB) {
...
*/
template <typename B>
static int BinomialHeap<B>::order(BinomialNode<B>* heap) {
